...
export const CommonPrinterSettingsEdit = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('Printer setting updated successfully!');
  ...
  return (
    <div className="p-6">
      <div className="mb-6 text-center">
        <h1 className="text-2xl font-bold text-gray-900">Edit Printer Setting</h1>
      </div>
