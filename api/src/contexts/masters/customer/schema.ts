...
export const CreateCustomerSchema = z
  .object({
    // Auto-generated by service when omitted (CUST0001-style sequence).
    code: z
      .string()
      .min(1)
      .max(32)
    ...
    // Customer master now supports only two invoice modes in UI/workflow.
    ...
    eWayBillNo: z.string().max(64).optional(),
    anprNumber: z.string().max(32).optional(),
...
export const UpdateCustomerSchema = z
  .object({
    ...
    eWayBillNo: z.string().max(64).nullable().optional(),
    anprNumber: z.string().max(32).nullable().optional(),
